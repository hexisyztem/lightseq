...
DecEncAttentionLayer<T1, T2>::DecEncAttentionLayer(
    ...
    : Layer("DecEncAttentionLayer"),  // necessary
      ...
      _bias_add_transform_20314_kv(new BiasAddTrans20314<T1, T2>(
  ...
  // parameters
  _attn_qw = new Variable(this->_name + "_attn_qw");
  _attn_qb = new Variable(this->_name + "_attn_qb");

  _attn_kvw = new Variable(this->_name + "_attn_kvw");
  _attn_kvb = new Variable(this->_name + "_attn_kvb");

  _attn_ow = new Variable(this->_name + "_attn_ow");
  _attn_ob = new Variable(this->_name + "_attn_ob");

  _attn_nw = new Variable(this->_name + "_attn_nw");
  _attn_nb = new Variable(this->_name + "_attn_nb");
...
DecEncAttentionLayer<T1, T2>::operator()(Variable* inp, Variable* enc_out) {
